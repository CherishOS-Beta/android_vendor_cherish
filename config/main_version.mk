...
CHERISH_PLATFORM_VERSION := 14.0
CHERISHVERSION := 5.0

ifeq ($(CHERISH_VANILLA), true)
CHERISH_VERSION := Cherish-OS-v$(CHERISHVERSION)-$(CHERISH_CODENAME)-$(CHERISH_BUILD_DATE)-$(CHERISH_BUILD)-$(CHERISH_BUILD_TYPE)-Vanilla
else
CHERISH_VERSION := Cherish-OS-v$(CHERISHVERSION)-$(CHERISH_CODENAME)-$(CHERISH_BUILD_DATE)-$(CHERISH_BUILD)-$(CHERISH_BUILD_TYPE)-GApps
endif
